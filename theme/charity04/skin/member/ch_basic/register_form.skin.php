...
<div class="row h1"><p class="hidden"></p></div>
            ...
            <?php }  ?>
                ...
                <input type="text" name="mb_email" value="<?php echo isset($member['mb_email'])?$member['mb_email']:''; ?>" id="reg_mb_email" required class="frm_input email full_input required" size="10" maxlength="20" placeholder="E-mail">
...
<div class="btn_confirm">
    <a href="<?php echo G5_URL ?>" class="btn btn-custom">취소</a>
    <input type="submit" value="<?php echo $w==''?'회원가입':'정보수정'; ?>" id="btn_submit" class="btn btn-custom" accesskey="s">
</div>
</form>
