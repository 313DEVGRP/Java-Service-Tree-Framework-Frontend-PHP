...
-->
	<div class="bo_w_tit write_div">
        <label for="wr_3">소스코드<br/><span style="color:#999;">iframe<br/>object ...</span></label>
        <div id="autosave_wrapper">
            <textarea name="wr_3" id="wr_3" style="width:100%; height:80px;"><?php echo $write['wr_3'] ?></textarea>
        </div>
    </div>


	<div class="bo_w_tit write_div">
       <label for="wr_4">동영상링크</label>
        <div id="autosave_wrapper">
