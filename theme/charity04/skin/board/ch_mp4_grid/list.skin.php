                        ...
                        <div class="desc">
                            <a href="#">
								...
								<?php if ($is_checkbox) { ?>
									...
									<label for="chk_wr_id_<?php echo $i ?>" class="sound_only"><?=cut_str($list[$i]['subject'],8)?></label>
								...
								<a href="<?php echo $list[$i]['href'] ?>">
									<?=cut_str($list[$i]['subject'],8)?>
									<?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">댓글</span><?php echo $list[$i]['comment_cnt']; ?><span class="sound_only">개</span><?php } ?>
								</a></h3>
                            </a>
                            <span class="text"><?php echo $list[$i]['datetime'] ?> 
                            </span>
                        </div>
                    </div>
                    <!-- event item close -->
