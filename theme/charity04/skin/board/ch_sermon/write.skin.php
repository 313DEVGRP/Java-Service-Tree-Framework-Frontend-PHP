	...
	<div class="container">
		<div class="row">
			...
			?>
                ...
                <?php } ?>
                <?php if ($option) { ?>
                <div class="write_div write-optioin">
				...
				<?php } ?>
					...
					<label for="wr_1">YOUTUBE ID</label>
					<input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" class="form-control">
					<div class="margin-hr-10"></div>
					<label for="wr_4">※ 동영상 링크 주소입력 (http:// 입력), 파일형식:mp4파일</label>
					<input type="text" name="wr_4" value="<?php echo $write['wr_4'] ?>" id="wr_4" class="form-control">


				<div class="bo_w_tit write_div">
					<label for="wr_subject">제목<strong class="sound_only">필수</strong></label>
					<div id="autosave_wrapper">
						<input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="form-control" placeholder="제목">
					</div>
				</div>
				<div class="margin-hr-10"></div>
				<div class="write_div">
				...
				<div class="btn_confirm write_div text-center">
					...
					<input type="submit" value="작성완료" id="btn_submit" accesskey="s" class="btn btn-custom">
				</div>
			</form>
<!-- } 게시판 읽기 끝 -->
<!-- content close -->
