...
<div id="content">
	<div class="container">
		<div class="row">
			...
			?></span></h1>
			<div class="col-md-12">
				<h3><span>인원: <?php echo $view['wr_5'] ?>명 &nbsp;&nbsp;기간:</i> <?php echo $view['wr_2'] ?> &nbsp;&nbsp;
				참가비: <?php echo number_format($view['wr_4']) ?>원 &nbsp;&nbsp;
				상태: <a href="<?php echo G5_HTTP_BBS_URL ?>/write.php?w=u&bo_table=eStatus&wr_id=<?php echo $view['wr_id'] ?>&page="> <?php echo $view['wr_10'] ?></a></h3><br>
<!-- 게시물 읽기 시작 { -->
				...
				<strong class="if_date"><span class="sound_only">작성일</span><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?></strong>
					...
					<img class="img-event img-full" src="<?php echo G5_DATA_URL.'/file/'.$bo_table.'/'.get_view_thumbnail($view['file'][0]['file']); ?>">
					<?php } else { ?>
