        ...
        <script type="text/template" id="settings-template">
            <div class="setting clearfix" style="margin-top: 5px;">
                ...
                <div class="btn-group" style="margin-top: 5px;">
                    <button type="button" class="btn btn-sm btn-default" style="margin-top: 0px;padding: 1px 7px;height: 25px;">Adm</button>
                    <button type="button" class="btn btn-sm btn-default" style="margin-top: 0px;padding: 1px 7px;height: 25px;">User</button>
                </div>
            </div>
            <div class="setting clearfix" style="margin-top: 15px;">
                ...
                <div id="display-sidebar-toggle" class="btn-group" data-toggle="buttons-radio" style="margin-top: 5px;">
                    ...
                    <button type="button" data-value="true" class="btn btn-sm btn-default <%= display? 'active' : '' %>" style="margin-top: 0px;padding: 1px 7px;height: 25px;">Show</button>
                    <button type="button" data-value="false" class="btn btn-sm btn-default <%= display? '' : 'active' %>" style="margin-top: 0px;padding: 1px 7px;height: 25px;">Hide</button>
                </div>
            </div>
            <div class="setting clearfix" style="margin-top: 15px;">
                <div>TourGuide</div>
                <div class="btn-group" style="margin-top: 5px;">
                    <button id="tour_guide_on" type="button" class="btn btn-sm btn-default" style="margin-top: 0px;padding: 1px 7px;height: 25px;">On</button>
                    <button id="tour_guide_off" type="button" class="btn btn-sm btn-default" style="margin-top: 0px;padding: 1px 7px;height: 25px;">Off</button>
                </div>
            </div>
        </script>
